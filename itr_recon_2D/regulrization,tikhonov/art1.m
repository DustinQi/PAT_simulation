...
% X......| The matrix to invert (with born/rytov its the perturbation) 初始矩阵，可设为全0
% Niter..| Number of iterations  比如设为120
% e......| Relaxation factor.  残差，比如设为0.1
%
% Output:
% -------
